...
// <auto-generated>
//
// Generated from file `GroupShoppingICE.ice'
//
// Warning: do not edit this file.
//
// </auto-generated>
...
(function(module, require, exports)
{
    ...
    var LuckyGroupShopping = __M.module("LuckyGroupShopping");
    Slice.defineSequence(LuckyGroupShopping, "PersonalDiscountListHelper", "Ice.DoubleHelper", true);

    LuckyGroupShopping.GroupShoppingClient = Slice.defineObject(
        undefined,
        Ice.Object, undefined, 1,
        [
            "::Ice::Object",
            "::LuckyGroupShopping::GroupShoppingClient"
        ],
        -1, undefined, undefined, false);

    LuckyGroupShopping.GroupShoppingClientPrx = Slice.defineProxy(Ice.ObjectPrx, LuckyGroupShopping.GroupShoppingClient.ice_staticId, undefined);

    Slice.defineOperations(LuckyGroupShopping.GroupShoppingClient, LuckyGroupShopping.GroupShoppingClientPrx,
    {
        "setCommodityInfo": [, , , , , , [[7], [3], [3], [6], ["LuckyGroupShopping.PersonalDiscountListHelper"], [6], [3], [3], [7]], , , , ],
        "signInByOthers": [, , , , , , , , , , ],
        "unsignIn": [, , , , , , , , , , ],
        "orderError": [, , , , , , , , , , ]
    });

    LuckyGroupShopping.GroupShoppingServer = Slice.defineObject(
        undefined,
        Ice.Object, undefined, 1,
        [
            "::Ice::Object",
            "::LuckyGroupShopping::GroupShoppingServer"
        ],
        -1, undefined, undefined, false);

    LuckyGroupShopping.GroupShoppingServerPrx = Slice.defineProxy(Ice.ObjectPrx, LuckyGroupShopping.GroupShoppingServer.ice_staticId, undefined);

    Slice.defineOperations(LuckyGroupShopping.GroupShoppingServer, LuckyGroupShopping.GroupShoppingServerPrx,
    {
        "getDiscountResult": [, , , , , [6], [[7], [7], [3], [3]], , , , ]
    });

    LuckyGroupShopping.Session = Slice.defineObject(
        undefined,
        Ice.Object, undefined, 1,
        [
            "::Ice::Object",
            "::LuckyGroupShopping::Session"
        ],
        -1, undefined, undefined, false);

    LuckyGroupShopping.SessionPrx = Slice.defineProxy(Ice.ObjectPrx, LuckyGroupShopping.Session.ice_staticId, undefined);

    Slice.defineOperations(LuckyGroupShopping.Session, LuckyGroupShopping.SessionPrx,
    {
        "refresh": [, 2, 2, , , , , , , , ],
        "getName": [, 2, 2, , , [7], , , , , ],
        "destroy": [, , , , , [1], [[7]], , , , ],
        "destroyByReconnect": [, , , , , , , , , , ],
        "destroyByConnect": [, , , , , , , , , , ],
        "updateBusiness": [, , , , , [1], [[7], [1]], , , , ]
    });

    LuckyGroupShopping.SessionManager = Slice.defineObject(
        undefined,
        Ice.Object, undefined, 1,
        [
            "::Ice::Object",
            "::LuckyGroupShopping::SessionManager"
        ],
        -1, undefined, undefined, false);

    LuckyGroupShopping.SessionManagerPrx = Slice.defineProxy(Ice.ObjectPrx, LuckyGroupShopping.SessionManager.ice_staticId, undefined);

    Slice.defineOperations(LuckyGroupShopping.SessionManager, LuckyGroupShopping.SessionManagerPrx,
    {
        "createSession": [, , , , , ["LuckyGroupShopping.GroupShoppingServerPrx"], [[Ice.Identity], [7], [7], [7], [3]], , , , ],
        "destroy": [, , , , , [1], [[7], [7]], , , , ],
        "refresh": [, , , , , , [[7], [7]], , , , ],
        "updateBusiness": [, , , , , [1], [[7], [7], [1]], , , , ]
    });
    exports.LuckyGroupShopping = LuckyGroupShopping;
}
...
var hostIndex = 0; // 0 is host; 1 is test; 2 is real
function ConsoleMyLog(obj) {
    if (hostIndex < 2)
        console.log(obj);
}

var LuckyGroupShoppingC;
(function (LuckyGroupShoppingC) {
    var GroupShoppingClientI = Ice.Class(LuckyGroupShopping.GroupShoppingClient, {

        setCommodityInfo: function (name, groupCount, currentGroupCount, totalDiscount, personalDiscountList, groupPrice, currentLevel, gameMode, timespan, current) {
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setCommodityName(name);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setGroupCount(groupCount);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setCurrentGroupCount(currentGroupCount);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setTotalDiscount(totalDiscount);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setPersonalDiscountList(personalDiscountList);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setGroupPrice(groupPrice);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setCurrentLevel(currentLevel);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setGameMode(gameMode);
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setTimeSpan(timespan);

            ConsoleMyLog('set groupshopping info success: ');
        },

        signInByOthers: function (current) {
            ConsoleMyLog('signinbyothers');
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setSignAgain(1);
        },

        unsignIn: function (current) {
            ConsoleMyLog('unsignin');
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setUnsignIn(1);
        },

        orderError: function (current) {
            ConsoleMyLog('orderError');
            LuckyGroupShoppingC.LuckyGroupShoppingClient.prototype.setOrderError(1);
        }
    });

    LuckyGroupShoppingC.GroupShoppingClientI = GroupShoppingClientI;

})(LuckyGroupShoppingC || (LuckyGroupShoppingC = {}));
...
(function (LuckyGroupShoppingC) {
    ...
    var serverprx = null;
    var sessionmgprx = null;
    var ident = null;

    function LuckyGroupShoppingClient() {
        var isConnect = 0; // 0 is disconnect; 1 is connect; 2 is reconnect;
        var isWoopra = false;
        var unsignIn = 0; // 0 is normal; 1 is unsign;
        var signAgain = 0; // 0 is normal; 1 is signagain;
        var orderError = 0; // 0 is normal; 1 is orderError;
        var closeGameState = 0; // -1 is error; 0 is normal; 1 is true; 2 is resume;
        var gameMode = 0; // 1 is normal; 2 is pay; free is 3; arena is 4; coupon is 5;
        var groupPrice = 0.0;
        var totalDiscount = 0.0;
        var groupCount = 0;
        var currentGroupCount = 0;
        var commodityName = '';
        var personalDiscountList = [];
        var isReConnect = 0;
        var isSignIn = false;
        var discount = 0;
        var currentLevel = 0;
        ...
        var c = LuckyGroupShoppingClient, p = c.prototype;
        ...
        p.connectInit = function (userGuid, gameInfoId, gameGuid, gameMode, isWss) {

            var id = new Ice.InitializationData();
            id.properties = Ice.createProperties();
            id.properties.setProperty('Ice.ACM.Client.Close', '0');
            id.properties.setProperty('Ice.ACM.Client.Heartbeat', '3');
            id.properties.setProperty('Ice.ACM.Client.Timeout', '30');
            ...
            if (hostIndex == 0)
                ...
                hostname = 'dev.xingyunmao.cn';
            else if (hostIndex == 2) {
                hostname = 'gamegsapi.xingyunmao.cn';
                if (isWss) {
                    mode = 'wss -p 10009';
                    ConsoleMyLog('wss');
                }
            ...
            var proxy = communicator.stringToProxy('luckygroupshopping:' + mode + ' -h ' + hostname);
            ConsoleMyLog(hostname);

            var SessionManagerPrx = LuckyGroupShopping.SessionManagerPrx;
            Ice.Promise.try(
                function () {
                    SessionManagerPrx.checkedCast(proxy).then(
                        function (sessionmanager) {
                            sessionmgprx = sessionmanager.ice_invocationTimeout(30000);
//                            sessionmgprx = sessionmgprx.ice_timeout(3000);

                            communicator.createObjectAdapter('').then(
                                function (adapter) {
                                    var r = adapter.addWithUUID(new LuckyGroupShoppingC.GroupShoppingClientI());

                                    connection = proxy.ice_getCachedConnection();
                                    connection.setAdapter(adapter);

                                    ident = r.ice_getIdentity();

                                    if (gameMode == GameMode.NORMAL) {
                                        sessionmgprx.createSession(ident, userGuid, gameInfoId, gameGuid, gameMode).then(
                                            function (server) {
                                                if (server) {
                                                    serverprx = server.ice_timeout(3000);
                                                    serverprx = server.ice_invocationTimeout(3000);
                                                    serverprx = serverprx.ice_endpoints(sessionmgprx.ice_getEndpoints());
                                                    isConnect = 1;
                                                }
                        ...
                        function (ex) {
                            ConsoleMyLog('connectInit error.');
                            ConsoleMyLog(ex);
                            isConnect = 2;
                        }
                    );
        ...
        p.refresh = function (gameGuid, gameInfoId) {
            if (sessionmgprx != null && isConnect == 1) {
                Ice.Promise.try(
                    function () {
                        sessionmgprx.refresh(gameGuid, gameInfoId).exception(
                            function (ex) {
                                ConsoleMyLog('refresh error.');
                                if (isReConnect == 0)
                                    isConnect = 2;
                            });
                    });
                ...
                ConsoleMyLog('refresh2 error');
            }

        };

        p.getDiscountResult = function(gameGuid, gameInfoId, currentLevel, gameMode)
        {
            if (serverprx != null) {
                Ice.Promise.try(
                    function () {
                        serverprx.getDiscountResult(gameGuid, gameInfoId, currentLevel, gameMode).then(
                            function (r) {
                                discount = r;
                            }).exception(
                            function (ex) {
                                ConsoleMyLog('getDiscountResult error.');
                                if (isReConnect == 0)
                                    isConnect = 2;
                            });
                    });
                ...
                ConsoleMyLog('getDiscountResult2 error');
            }
        };

        p.setIdentifyingCode = function (cellphoneNumber) {
            try {
                if (isSendCode == 0) {
                    isSendCode = 1;
                    app.core.scnc('GASX', cellphoneNumber, function (r) {
                        if (r == 0) {
                            isSendCode = 0;
                        }
                    });
        ...
        p.checkActivate = function () {
            try {
                if (app.core.$rootScope.loginUser.UserStatus == 0)
                    return true;
            }
            catch(e){
                ConsoleMyLog(e);
        ...
        p.submitDatas = function(cellphoneNumber, code) {
            try {
                app.core.bcn(cellphoneNumber, code, function(r) {
                    if (r.ok == false)
                    {
                        submitResult = 0;
                        submitMsg = r.msg;
        ...
        p.updateBusiness = function (gameGuid, gameInfoId, gameMode, betin, payout_discount, payout_coupon, productname, modename) {
            if (sessionmgprx != null) {
                Ice.Promise.try(
                    function () {
                        sessionmgprx.updateBusiness(gameGuid, gameInfoId, true).then(
                            function (r) {
                                if (r && p.getIsWoopra() == false/* && isTimeLimit == 1*/) {
                                    p.updateWoopra(gameMode, betin, payout_discount, payout_coupon, productname, modename);
                                    p.setIsWoopra(true);
                                }
                            }).exception(
                            function (ex) {
                                ConsoleMyLog('updateBusiness error.');
                                if (isReConnect == 0)
                                    isConnect = 2;
                            });
                    });
                ...
                ConsoleMyLog('updateBusiness2 error');
            }
        };

        p.destroyServer = function (gameGuid, gameInfoId, gameMode, betin, payout_discount, payout_coupon, productname, modename) {
            if (sessionmgprx != null) {
                Ice.Promise.try(
                    function () {
                        sessionmgprx.destroy(gameGuid, gameInfoId).then(
                            function (r) {
                                if (r == true) {
                                    if (p.getIsWoopra() == false/* && isTimeLimit == 1*/) {
                                        p.updateWoopra(gameMode, betin, payout_discount, payout_coupon, productname, modename);
                                        p.setIsWoopra(true);
                                    }
                                    ...
                                    p.destroyClient();
                                    closeGameState = 1;
                                    ConsoleMyLog('destroyClient: ' + closeGameState);
                                    //var global = LuckyPinball.Global.CreateInstance();
                                    //global.normalView.closeGame();
                                }
                                else {
                                    closeGameState = -1;
                                    ConsoleMyLog('destroy server fail');
                                    //var global = LuckyPinball.Global.CreateInstance();
                                    //global.normalView.closeGame();
                                }
                            }).exception(
                            function (ex) {
                                closeGameState = -1;
                                ConsoleMyLog('destroyServer error.');
                                //var global = LuckyPinball.Global.CreateInstance();
                                //global.normalView.closeGame();
                            });
                    });
                ...
                closeGameState = -1;
                ConsoleMyLog('destroyServer2 error');
                //var global = LuckyPinball.Global.CreateInstance();
                //global.normalView.closeGame();
            }
        ...
        p.closeGame = function (auth, mode, orderid, state, fromAdd) {
            var msg = {
                auth: auth,
                mode: mode,
                orderid: orderid,
            ...
            try {
                window.parent.postMessage(msg, fromAdd);
            }
            catch (e) {
                ConsoleMyLog(e);
            }
            ConsoleMyLog('closeGame');
        };
        ...
        p.updateWoopra = function (gameMode, betin, payout_discount, payout_coupon, productname, modename) {
            try {
                var woopra = app.core.woopraService;
                ConsoleMyLog(woopra);
                //if (gameMode == GameMode.NORMAL) {
                //    woopra.evet.PG.properties.gamename = '����С��';
                //    woopra.evet.PG.properties.mode = modename; // '����' '����'
                //    woopra.evet.PG.properties.betin = betin;
                //    woopra.evet.PG.properties.payout_discount = payout_discount;
                //    woopra.evet.PG.properties.payout_coupon = payout_coupon;
                //    woopra.evet.PG.properties.productname = productname;
                //    woopra.track(woopra.evet.PG);
                //}
            }
            catch (e) {
                ConsoleMyLog(e);
        ...
        p.GetRound = function (num) {
            return Math.round(num * 100) / 100;
        };

        p.getHostIndex = function () {
            return hostIndex;
        };

        p.getCloseGameState = function () {
            return closeGameState;
        };
        p.resumeCloseGameState = function () {
            closeGameState = 2;
        };

        p.getIsWoopra = function () {
            return isWoopra;
        };
        p.setIsWoopra = function (iw) {
            isWoopra = iw;
        };

        p.getCommodityName = function () {
            return commodityName;
        };
        p.setCommodityName = function (commodity) {
            commodityName = commodity;
        };

        p.getGroupPrice = function () {
            return groupPrice;
        };
        p.setGroupPrice = function (gp) {
            groupPrice = gp;
        };

        p.getIsConnect = function () {
            return isConnect;
        };
        p.setIsConnect = function (is) {
            isConnect = is;
        };
        p.lostPackage = function () {
            isConnect = 0;
        };

        p.getGroupCount = function () {
            return groupCount;
        };
        p.setGroupCount = function (gc) {
            groupCount = gc;
        };

        p.getCurrentGroupCount = function () {
            return currentGroupCount;
        };
        p.setCurrentGroupCount = function (cgc) {
            currentGroupCount = cgc;
        };

        p.getTotalDiscount = function () {
            return totalDiscount;
        };
        p.setTotalDiscount = function (td) {
            totalDiscount = td;
        };

        p.getUnsignIn = function () {
            return unsignIn;
        };
        p.setUnsignIn = function (un) {
            unsignIn = un;
        };

        p.getSignAgain = function () {
            return signAgain;
        };
        p.setSignAgain = function (sa) {
            signAgain = sa;
        };

        p.getOrderError = function () {
            return orderError;
        };
        p.setOrderError = function (oe) {
            orderError = oe;
        };

        p.getGameMode = function () {
            return gameMode;
        };
        p.setGameMode = function (game) {
            gameMode = game;
        };

        p.getIsReConnect = function () {
            return isReConnect;
        };
        p.setIsReConnect = function (r) {
            isReConnect = r;
        };

        p.getIsSignIn = function () {
            return isSignIn;
        };
        p.setIsSignIn = function (si) {
            isSignIn = si;
        };

        p.getPersonalDiscountList = function () {
            return personalDiscountList;
        };
        p.setPersonalDiscountList = function (pdl) {
            personalDiscountList = pdl;
        };

        p.getDiscount = function() {
            return discount;
        };
        p.resumeDiscount = function() {
            discount = 0;
        };

        p.getCurrentLevel = function() {
            return currentLevel;
        };
        p.setCurrentLevel = function(cl) {
            currentLevel = cl
        };
        ...
        p.setTimeSpan = function(et) {
            timespan = et;
        };

        p.getSubmitResult = function() {
            return submitResult;
        };
        p.resumeSubmitResult = function() {
            submitResult = -1;
        };

        p.getSubmitMsg = function() {
            return submitMsg;
        };
    }

    LuckyGroupShoppingC.LuckyGroupShoppingClient = LuckyGroupShoppingClient;
